...
export const getAttributeLabel = (
  ...
  schemaAttributes: CsvMapperRepresentationAttributesFormQuery$data['schemaAttributes'],
) => {
  const foundAttribute = schemaAttributes?.find(
