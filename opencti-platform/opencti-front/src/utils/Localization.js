const i18n = {
  messages: {
    'es-es': {
      ...
      'Settings default values': 'Valores predeterminados de configuración: {value}',
      'Settings default values usage...': 'Se utilizará automáticamente si la columna está vacía. Si desea especificar otro valor predeterminado, puede anularlo con el campo de arriba.',
      'No default value set in Settings...': 'No hay ningún valor predeterminado establecido en Configuración > Personalización. Si desea especificar un valor predeterminado, puede completar el campo de arriba.',
    },
    'fr-fr': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      'Settings default values': 'Valeurs par défaut des paramètres : {value}',
      'Settings default values usage...': 'Elle sera automatiquement utilisé si la colonne est vide. Si vous souhaitez plutôt spécifier une autre valeur par défaut, vous pouvez la remplacer avec le champ ci-dessus.',
      'No default value set in Settings...': 'Aucune valeur par défaut définie dans Paramètres > Personnalisation. Si vous souhaitez spécifier une valeur par défaut, vous pouvez remplir le champ ci-dessus.',
    },
    'ja-jp': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      'Settings default values': 'S設定のデフォルト値: {value}',
      'Settings default values usage...': '列が空の場合は自動的に使用されます。代わりに他のデフォルト値を指定したい場合は、上のフィールドでそれをオーバーライドできます。',
      'No default value set in Settings...': '[設定] > [カスタマイズ] にはデフォルト値が設定されていません。デフォルト値を指定する場合は、下のフィールドに入力します。',
    },
    'zh-cn': {
      // Titles
      'OpenCTI - Cyber threat intelligence platform':
      ...
      'Settings default values': '设置默认值： {value}',
      'Settings default values usage...': '如果该列为空，它将自动使用。如果您想指定其他默认值，可以使用上面的字段覆盖它。',
      'No default value set in Settings...': '设置 > 自定义中未设置默认值。如果您想指定默认值，可以填写下面的字段。',
    },
    'en-us': {
      gt: 'Greater than',
      ...
      'Settings default values': 'Settings default values: {value}',
      'Settings default values usage...': 'It will be automatically used if the column is empty. If you want to specify an other default value instead, you can override it with the field above.',
      'No default value set in Settings...': 'No default value set in Settings > Customization. If you want to specify a default value, you can fill the field above.',
    },
  },
};
